...
class CrystDataModule(pl.LightningDataModule):
    ...
    def get_scaler(self, scaler_path):
        ...
        if scaler_path is None:
            ...
            if os.path.exists(Path(scaler_path) / 'cart_coord_scaler.pt'):
                self.cart_scaler = torch.load(Path(scaler_path) / 'cart_coord_scaler.pt')
            else:
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage is None or stage == "fit":
            ...
            self.train_dataset.cart_scaler = self.cart_scaler
            for val_dataset in self.val_datasets:
                val_dataset.lattice_scaler = self.lattice_scaler
                val_dataset.scaler = self.scaler
                val_dataset.cart_scaler = self.cart_scaler
        ...
        for test_dataset in self.test_datasets:
            ...
            test_dataset.cart_scaler = self.cart_scaler
