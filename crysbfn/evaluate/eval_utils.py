...
from crysbfn.common.constants import CompScalerMeans, CompScalerStds
from crysbfn.common.data_utils import StandardScaler, chemical_symbols
from crysbfn.pl_data.dataset import TensorCrystDataset
from crysbfn.pl_data.datamodule import worker_init_fn
...
def get_model_path(eval_model_name):
    import crysbfn
    model_path = (
        Path(crysbfn.__file__).parent / 'prop_models' / eval_model_name)
    return model_path
